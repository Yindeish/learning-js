...
const page = () => {
    ...
    // : called column is used for many things in Javascript/Typescript
    // variable declaration in an object (instead of = sign)
    // Indicating the type of a variable (Type Annotation)
    // it is used for Renaming in descturing object

    
    
    const { gas: gas1, petrol: petrol1 } = petroleum;
