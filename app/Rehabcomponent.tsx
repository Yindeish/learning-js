...
export const list = ['one', 'two', 'three', 'four'] //Array of string

export const numbers = [10, 20, 30, 40] //Array of string

export const booleans = [true, false, false, true] //Array of string

export const arrayOfArrays = [[10, 20, 30, 40], [true, false, false, true], ['one', 'two', 'three', 'four']]
// console.table(users);
